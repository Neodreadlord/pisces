...
def get_all_forms(url):
    """Return all forms from supplied url"""
    soup = bs(s.get(url).content, "html.parser")
    return soup.find_all("form")


def get_form_details(form):
    """This function extracts all possible useful information about a HTML form"""
    details = {}
...
def is_vulnerable(response):
    """A boolean to decide if a page is vulnerable or not"""
    errors = {
        # MySQL
